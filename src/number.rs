...
mod tests {
    ...
    const DATA: [u8; 16] = [
        0x12, 0x34, 0x56, 0x78, 0x9A, 0xBC, 0xDE, 0xF0, 0xFF, 0xED, 0xCB, 0xA9, 0x87, 0x65, 0x43,
        0x21,
    ];
    ...
    impl_test_unpack_number!(
        u128,
        be = 0x123456789abcdef0ffedcba987654321,
        le = 0x21436587a9cbedfff0debc9a78563412
    );
    ...
    impl_test_unpack_number!(
        f64,
        be = 5.626349274901198e-221,
        le = -4.886459655043775e+235
    );
